...
function insertSpeech(speechObject, word) {
  ...
  speechObject.style.backgroundImage = 'url(' + chrome.extension.getURL('/pubAssets/fanyi/sound.png') + ')';
