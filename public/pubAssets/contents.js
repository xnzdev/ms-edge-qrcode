...
function xnzAtip12(id, content) {
	...
	var divTi = document.createElement("span");
	var divBo = document.createElement("span");
	divTi.innerHTML = "\u8bd1：";
	divBo.innerText = content;
	divTi.style.color = "#1890ff";
	return xnzJQ(div).append(divTi).append(divBo);
}
...
xnzJQ(function ($) {
	...
	function xnzAtip(id, content) {
		...
		var divBo = document.createElement("div");
		divTi.innerHTML = "Best \u7ffb\u8bd1";
		divBo.innerText = content;
		divTi.style.background = "#e6f7ff";
		divTi.style.margin = "-10px -10px 0 -10px";
		divTi.style.padding = "6px 10px";
		divTi.style.color = "#1890ff";
		divBo.style.paddingTop = "6px";
